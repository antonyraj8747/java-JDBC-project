...
public class UpdateEmployeeDetails extends JFrame 
{
	...
	public UpdateEmployeeDetails() 
	{
		...
		lblUpdateCustomerDetails.setBounds(95, 20, 260, 28);
		...
		btnUpdate.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				try
				{
					...
					String query="update EMPLOYEEDETAILS  set name='"+en+"', address='"+ea+"', phoneno='"+ep+"'  where id='"+id+"'";
		...
		btnUpdate.setBounds(163, 377, 120, 30);
